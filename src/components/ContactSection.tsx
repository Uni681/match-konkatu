...
export function ContactSection() {
  return html`
    <section class="contact-access-section">
      <!-- CONTACTブロック - 完全フルブリード（padding一切なし） -->
      <div class="contact-block relative overflow-hidden">
        ...
        <div class="relative z-20 grid grid-cols-1 lg:grid-cols-2 gap-8 py-16 px-6 lg:py-24 lg:px-16 container mx-auto max-w-7xl">
